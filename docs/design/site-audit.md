...
2026-09-15の設計時点の記録。2026-09-16に [ADR 0032](../decisions/0032-site-audit-mariadb.md) で採用・実装した。以下は比較・検討の経緯として残す。現在の動作・設計案との差異は [仕様](../spec/audit.md)、検証結果は [実装検証](../reviews/2026-09-16-audit-implementation.md) を参照。本番DB適用済みという意味ではない。
